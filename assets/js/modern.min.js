$(document).ready(function() {
    ...
    $(".push-sidebar").click(function() {
        var e = $(".sidebar");
        e.hasClass("visible") ? (e.removeClass("visible"),
        $(".page-inner").removeClass("sidebar-visible")) : (e.addClass("visible"),
    ...
    $(".sidebar .accordion-menu > li.droplink > a").click(function() {
        if (!$("body").hasClass(".small-sidebar") && !$("body").hasClass(".page-horizontal-bar") && !$("body").hasClass(".hover-menu")) {
            ...
            c(),
            a.is(":visible") ? a.slideUp(200, function() {
                c()
    ...
    var c = function() {
        {
            var e, a = $(".page-inner"), o = $(".page-sidebar"), n = $("body"), s = $(".page-footer").outerHeight();
            $(".page-content").height()
        }
        a.attr("style", "min-height:" + o.height() + "px !important"),
        n.hasClass("page-sidebar-fixed") ? e = o.height() + s : (e = o.height() + s,
    ...
    var t = document.querySelector(".fixed-header-check")
      ...
      , r = document.querySelector(".boxed-layout-check")
      ...
      , b = function() {
        ...
        $(".page-content").hasClass("container") && 1 == r.checked && r.click(),
      ...
      , f = function() {
        $("body").hasClass("page-horizontal-bar") && $("body").hasClass("page-sidebar-fixed") && $("body").hasClass("page-header-fixed") && (i.click(),
      ...
      , k = function() {
        !$("body").hasClass("page-horizontal-bar") || $("body").hasClass("page-sidebar-fixed") || $("body").hasClass("page-header-fixed") || (t.click(),
        alert("Fixed horizontal nav isn't compatible with static header mode. Modern will set fixed mode on header.")),
        $("body").hasClass("hover-menu") && !$("body").hasClass("page-sidebar-fixed") && (u.click(),
      ...
      , y = function() {
        ...
        $("body").hasClass("page-sidebar-fixed") && !$("body").hasClass("page-header-fixed") && (t.click(),
        alert("Static header isn't compatible with fixed horizontal nav mode. Modern will set static mode on horizontal nav.")),
        c()
    }
      , C = function() {
      ...
      , x = function() {
        !$("body").hasClass("hover-menu") && $("body").hasClass("page-sidebar-fixed") && (i.click(),
    ...
    ;
    $(".small-sidebar .navbar .logo-box a span").html($(".navbar .logo-box a span").text() == p ? m : p),
    $(".theme-settings").length || $(".sidebar-toggle").click(function() {
        g()
    }),
    ...
    $("body").hasClass("page-sidebar-fixed") || 1 != i.checked || $("body").addClass("page-sidebar-fixed"),
    $("body").hasClass("page-sidebar-fixed") && 0 == i.checked && $(".fixed-sidebar-check").prop("checked", !0),
    $("body").hasClass("page-header-fixed") || 1 != t.checked || $("body").addClass("page-header-fixed"),
    $("body").hasClass("page-header-fixed") && 0 == t.checked && $(".fixed-header-check").prop("checked", !0),
    $("body").hasClass("page-horizontal-bar") || 1 != l.checked || ($("body").addClass("page-horizontal-bar"),
    $(".sidebar").addClass("horizontal-bar"),
    $(".sidebar").removeClass("page-sidebar")),
    $("body").hasClass("page-horizontal-bar") && 0 == l.checked && $(".horizontal-bar-check").prop("checked", !0),
    $("body").hasClass("small-sidebar") || 1 != d.checked || $("body").addClass("small-sidebar"),
    $("body").hasClass("small-sidebar") && 0 == d.checked && $(".horizontal-bar-check").prop("checked", !0),
    $(".page-content").hasClass("container") || 1 != r.checked || $(".toggle-sidebar-check").addClass("container"),
    $(".page-content").hasClass("container") && 0 == r.checked && $(".boxed-layout-check").prop("checked", !0),
    $(".page-content").hasClass("container") || 1 != r.checked || $(".toggle-sidebar-check").addClass("container"),
    $(".page-content").hasClass("container") && 0 == r.checked && $(".boxed-layout-check").prop("checked", !0),
    $(".page-content").hasClass("container") || 1 != r.checked || $(".toggle-sidebar-check").addClass("container"),
    $(".page-content").hasClass("container") && 0 == r.checked && $(".boxed-layout-check").prop("checked", !0));
