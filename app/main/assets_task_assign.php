                ...
                <div class="col-md-12">
                    <div class="panel panel-white">
                        <div class="panel-body">
                            ...
                            ?>
                            <!--button id="openModalAP" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addVersion"> TASK ASSIGN </button-->
                        </div>
                    </div>
                </div>
            </div><!-- Row -->

            <div id = "artist_list" class="row">
                <div class="col-md-12">
                    <div class="panel panel-white">
                        <div class="panel-body">

                            <div class="error" id="artist_datatable_error_div" style="display:none;">
                                <hr>
                                <div class="col-md-offset-4 col-md-6"><strong>No Artist data found</strong></div>
                                <br>
                                <hr>
                            </div>

                            <!-- Table for Asset List-->
                            <div class="table-responsive" id="artist_datatable_div">
                                <div id="msg"></div>
                                <table id="artist_table" class="display">
                                    <thead>
                                    <tr>
                                        <th>ARTIST ID</th>
                                        <th>ARTIST NAME</th>
                            ...
                            <!-- End of Completed Table for Asset List-->
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4"><strong>Artist ID : </strong><span id="artist_id"></span></div>
                                        <div class="col-md-4"><strong>Artist Name : </strong><span id="artist_name"></span></div>
                                        <div class="col-md-4"><strong>Artist Skills : </strong><span id="artist_skills"></span></div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="error" id="asset_datatable_error_div" style="display:none;">
                                        <hr>
                                        <div class="col-md-offset-4 col-md-6"><strong>No data found for selected project</strong></div>
                                        <br>
                                        <hr>
                                    </div>

                                    <!-- Table for Completed Task List-->
                                    <div class="table-responsive" id="asset_datatable_div">
                                        <div id="msg"></div>
                                        ...
                                        <form id="submitAssignment">
                                            <div id="taskSelect" class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <input id="aid" name="aid" val="" type="hidden"/>
                                                    <input id="qty" name="qty" val="" type="hidden" />
                                                    <input id="selected" name="selected" val="" type="hidden"/>
                                                    <input id="submit" type="submit" name="submit" class="btn btn-default btn-assign" value="ASSIGN"><img src="../../../assets/custom/loading.gif" id="img" style="display:none"/ >
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<script src="//cdn.datatables.net/plug-ins/1.10.12/api/processing().js"></script>
<script src="../../assets/js/custom.js"></script>
<script src="js/run-toast.js"></script>
<script src="js/getProjectList.js"></script>
<script src="js/task-assign.js"></script>
